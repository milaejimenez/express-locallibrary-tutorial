  ...
  async.parallel(
    ...
    (err, results) => {
      ...
      res.render("book_delete", {
        title: "Delete Book",
        book: results.book,
        instances_books: results.instances_books,
      });
    }
  );
};
...
exports.book_delete_post = (req, res, next) => {
  async.parallel(
    ...
    (err, results) => {
      ...
      Book.findByIdAndRemove(req.body.bookid, (err, result) => {
        if (err) {
          return next(err);
        }
...
exports.book_update_post = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      // Render again. Get all authors and genres for form.
      async.parallel(
        {
          authors(callback) {
            Author.find(callback);
